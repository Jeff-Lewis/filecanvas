...
(function() {
  ...
  Dropbox.Client = (function() {
    ...
    Client.prototype.pullChanges = function(cursor, pathPrefix, callback) {
      var params, xhr;
      if ((!callback) && (typeof pathPrefix === 'function')) {
        callback = pathPrefix;
        pathPrefix = null;
      } else if ((!callback) && (!pathPrefix) && (typeof cursor === 'function')) {
        callback = cursor;
        pathPrefix = null;
        cursor = null;
      }
    ...
    Client.prototype.delta = function(cursor, pathPrefix, callback) {
      return this.pullChanges(cursor, pathPrefix, callback);
    };
