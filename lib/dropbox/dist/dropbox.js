...
(function() {
  ...
  Dropbox.Client = (function() {
    ...
    Client.prototype.pullChanges = function(cursor, options, callback) {
      var params, xhr;
      if ((!options) && (!callback) && (typeof cursor === 'function')) {
        callback = cursor;
        cursor = null;
        options = null;
        ...
        callback = options;
        options = null;
      } else if ((!callback) && (typeof options === 'function') && (!cursor.cursorTag) && (typeof cursor === 'object')) {
        callback = options;
        cursor = null;
        options = cursor;
      }
    ...
    Client.prototype.delta = function(cursor, options, callback) {
      return this.pullChanges(cursor, options, callback);
    };
  ...
  Dropbox.Http.PulledChanges = (function() {
    PulledChanges.parse = function(deltaInfo, options) {
      if (deltaInfo && typeof deltaInfo === 'object') {
        return new Dropbox.Http.PulledChanges(deltaInfo, options);
      } else {
        return deltaInfo;
      }
    };
    ...
    PulledChanges.prototype.options = void 0;
    ...
    function PulledChanges(deltaInfo, options) {
      var entry;
