...
shunt.users.ensureIndex({ 'uid': 1 }, { 'unique': true });
print(' - Setting \'alias\' index on \'users\' collection...');
shunt.users.ensureIndex({ 'alias': 1 }, { 'unique': true });

print(' - Setting \'user, alias\' index on \'sites\' collection...');
shunt.sites.ensureIndex({ 'user': 1, 'alias': 1 }, { 'unique': true });
print(' - Setting \'user\' index on \'sites\' collection...');
shunt.sites.ensureIndex({ 'user': 1 });
